...
```
    ...
    Features: ['Aa', 'a', 'b', 'c']
    Label: complication
    Loss test: 23.202123641967773
    Step: 0, Initial Loss: 23.202123641967773
    Step: 1,         Loss: 9.334371566772461
    Epoch 000: Loss: 64.220, Accuracy: 65.909%
    Epoch 050: Loss: 0.475, Accuracy: 79.545%
    Epoch 100: Loss: 0.373, Accuracy: 81.818%
    Epoch 150: Loss: 0.424, Accuracy: 86.364%
    Epoch 200: Loss: 0.368, Accuracy: 86.364%
    Epoch 250: Loss: 0.421, Accuracy: 88.636%
...
```
    ...
    Example 1 prediction: Any Complication (63.8%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (70.5%)
    Example 1 prediction: Any Complication (99.7%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (71.1%)
    Example 1 prediction: No Complication (99.6%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (71.7%)
    Example 1 prediction: Severe Complication (99.8%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (68.8%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (64.5%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (60.0%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (51.4%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: Any Complication (57.9%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: Any Complication (66.7%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: Any Complication (74.5%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
