...
```
    ...
    Features: ['Aa', 'a', 'b', 'c']
    Label: complication
    Loss test: 47.30071258544922
    Step: 0, Initial Loss: 47.30071258544922
    Step: 1,         Loss: 21.183401107788086
    Epoch 000: Loss: 78.352, Accuracy: 29.545%
    Epoch 050: Loss: 0.509, Accuracy: 77.273%
    Epoch 100: Loss: 0.437, Accuracy: 75.000%
    Epoch 150: Loss: 0.564, Accuracy: 77.273%
    Epoch 200: Loss: 0.396, Accuracy: 77.273%
    Epoch 250: Loss: 0.362, Accuracy: 84.091%
...
```
    ...
    Example 0 prediction: No Complication (79.0%)
    Example 1 prediction: Any Complication (62.1%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (79.4%)
    Example 1 prediction: Severe Complication (60.7%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (79.7%)
    Example 1 prediction: Severe Complication (94.2%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (80.1%)
    Example 1 prediction: Severe Complication (99.4%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (80.5%)
    Example 1 prediction: Severe Complication (99.9%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (80.8%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (81.2%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (75.3%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (99.9%)
    Example 0 prediction: No Complication (66.9%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (99.8%)
    Example 0 prediction: No Complication (57.3%)
    Example 1 prediction: Severe Complication (99.9%)
    Example 2 prediction: Severe Complication (99.4%)
    Example 0 prediction: Any Complication (52.8%)
    Example 1 prediction: Severe Complication (98.7%)
    Example 2 prediction: Severe Complication (98.5%)
