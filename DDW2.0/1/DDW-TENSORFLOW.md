...
```
    ...
    Label: complication
    Loss test: 22.51616668701172
    Step: 0, Initial Loss: 22.51616668701172
    Step: 1,         Loss: 25.379241943359375
    Epoch 000: Loss: 26.349, Accuracy: 43.182%
    Epoch 050: Loss: 0.911, Accuracy: 72.727%
    Epoch 100: Loss: 0.742, Accuracy: 75.000%
    Epoch 150: Loss: 0.649, Accuracy: 75.000%
    Epoch 200: Loss: 0.600, Accuracy: 75.000%
    Epoch 250: Loss: 0.669, Accuracy: 75.000%
    Test set accuracy: 86.364%
    Example 0 prediction: No Complication (70.3%)
    Example 1 prediction: Severe Complication (78.8%)
    Example 2 prediction: Severe Complication (81.7%)
...
```
    ...
    Features: ['Aa', 'a', 'b', 'c']
    Label: complication
    Loss test: 62.64899444580078
    Step: 0, Initial Loss: 62.64899444580078
    Step: 1,         Loss: 50.51853942871094
    Epoch 000: Loss: 50.714, Accuracy: 25.000%
    Epoch 050: Loss: 0.473, Accuracy: 77.273%
    Epoch 100: Loss: 0.377, Accuracy: 79.545%
    Epoch 150: Loss: 0.398, Accuracy: 81.818%
    Epoch 200: Loss: 0.395, Accuracy: 79.545%
    Epoch 250: Loss: 0.387, Accuracy: 84.091%
...
```
    ...
    Example 0 prediction: No Complication (89.2%)
    Example 1 prediction: No Complication (100.0%)
    Example 2 prediction: Severe Complication (98.4%)
    Example 0 prediction: No Complication (88.5%)
    Example 1 prediction: No Complication (100.0%)
    Example 2 prediction: Severe Complication (98.9%)
    Example 0 prediction: No Complication (87.9%)
    Example 1 prediction: No Complication (100.0%)
    Example 2 prediction: Severe Complication (99.0%)
    Example 0 prediction: No Complication (86.6%)
    Example 1 prediction: No Complication (100.0%)
    Example 2 prediction: Severe Complication (99.1%)
    Example 0 prediction: No Complication (84.6%)
    Example 1 prediction: Severe Complication (95.7%)
    Example 2 prediction: Severe Complication (99.2%)
    Example 0 prediction: No Complication (82.5%)
    Example 1 prediction: Severe Complication (90.7%)
    Example 2 prediction: Severe Complication (99.8%)
    Example 0 prediction: No Complication (80.1%)
    Example 1 prediction: Severe Complication (93.7%)
    Example 2 prediction: Severe Complication (99.9%)
    Example 0 prediction: No Complication (77.4%)
    Example 1 prediction: Severe Complication (96.2%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (74.5%)
    Example 1 prediction: Severe Complication (99.9%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (71.3%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
    Example 0 prediction: No Complication (67.9%)
    Example 1 prediction: Severe Complication (100.0%)
    Example 2 prediction: Severe Complication (100.0%)
